...
//        Log.v(TAG, "Start delete FoodDeal");
...
//                Log.v(TAG, "End delete Food Deals");
//            }
//
//            @Override
...
//        Log.v(TAG, "Start Create Food Deal");
//        final boolean[] ifSuccess = {false};
...
//                }
//                ifNdone[0] = false;
//                Log.v(TAG, "End Create Food Deal");
//            }
//
//            @Override
...
//            Log.d(TAG, "Size of list :" + DataHolder.getInstance().getFoodDealList().size());
//        }
//
//        return ifSuccess[0];
//    }
...
//    }
//
    public void patchFoodDeal(int id, FoodDeal foodDeal) {
