...
public class Event {
    ...
    public Event(Integer id, String name, String description, String startTime, String facebookId, String startDate, String endDate, String endTime, String placeName, String city, String country, String latitude, String longitude, String state, String street, String zip, String coverId, String sourceUrl) {
        this.id = id;
        this.name = name;
