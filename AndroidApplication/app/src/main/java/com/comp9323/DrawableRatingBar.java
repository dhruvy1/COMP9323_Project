...
//
//Not in use, since Don't know how to use
///**
// * A costumed Rating bar that allow developer to :
// *  1) set the size of the RatingBar icons
// *  2) custom tint colors for rating images.
// *  3) set padding on your RatingBar
// *  4) set custom width and height
// *   with XML declaration.
// *
// * Created by <a src= "https://goo.gl/YWypzJ">box</a></a>from stackoverflow on May 26, 2016 at 12:19
// * retrieved from<a src=" https://goo.gl/ZJLz72">https://goo.gl/ZJLz72</a>
// */
