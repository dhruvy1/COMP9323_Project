...
{#      </div>#}
    ...
    <div class="col-sm-10">
      ...
      {% else %}
          <a class="btn btn-primary btn-md pull-right" href="{% url 'qa_create_answer' question.id %}" role="button">Answer this Question!</a>
          <a class="btn btn-primary btn-md pull-right" href="{% url 'qa_create_question_comment' question.id %}" role="button">comment this Question!</a>
      {% endif %}
      </p>
    </div>
  </div>
...
{% if answers %}
  ...
  <hr/>
    ...
    <div class="row">
      ...
      <div class ="col-md-1">
{#        <div class="row">#}
          <div class ="col-xs-1"><big class="pull-left custom-big"><b>{{ answer.total_points }}</b></big></div>
          <div class ="col-xs-1">
...
{#        </div>#}
      ...
      <div class ="col-xs-9">
        ...
        {% if answer.user == user %}<a href="{% url 'qa_update_answer' answer.id %}" class="pull-right"><small>Edit &nbsp;</small></a>{% endif %}
            <blockquote class="blockquote"><div id="ans" class="lead">{{ answer.answer_text|markdown }}</div></blockquote>
