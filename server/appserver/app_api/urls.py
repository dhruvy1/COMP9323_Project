...
urlpatterns = [
    ...
    url(r'mobile_users/create/$', MobileUserCreateAPIView.as_view(), name='create'),
    url(r'mobile_users/(?P<pk>[0-9]+)/$', MobileUserDetailAPIView.as_view(), name='detail'),
    url(r'mobile_users/(?P<pk>[0-9]+)/edit/$', MobileUserUpdateAPIView.as_view(), name='update'),
    url(r'mobile_users/(?P<pk>[0-9]+)/delete/$', MobileUserDestroyAPIView.as_view(), name='destroy'),
    # Event urls
    url(r'events/$', EventListAPIView.as_view(), name='list'),
    url(r'events/(?P<pk>[0-9]+)/$', EventDetailAPIView.as_view(), name='detail'),
    url(r'events/create/$', EventCreateAPIView.as_view(), name='create'),
